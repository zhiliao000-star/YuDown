...
import { MessageSquareText, Copy, CheckCircle2, MapPin, Clock, Luggage, AlertCircle, Check, Search } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="shrink-0 whitespace-nowrap rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-blue-700">
          {message.scenarioChinese}
        </span>
      </div>
...
export const DriverEnglishPackPage: React.FC = () => {
  ...
  return (
    <main className="w-full bg-white">
      ...
      <section className="mx-auto w-full max-w-[1100px] px-4 py-16 sm:px-5 sm:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-gray-600 sm:text-xl">
            ...
            and address changes.
            <br />
            <span className="mt-3 block text-base text-gray-500">
              为中国驾驶员量身定制的英文消息包，涵盖 Uber/Lyft 运营中最常见的场景。
            </span>
          </p>
      ...
      {/* Complete Message Library Section */}
      <section className="mx-auto w-full max-w-[1100px] px-4 py-16 sm:px-5 sm:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Every message is in English with side-by-side Chinese. Search below to find what you need.
          </p>
        </div>
        ...
        <div className="relative mt-8 max-w-2xl">
          <input
            ...
            placeholder="Search messages by scenario, English, or Chinese..."
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          {filteredMessages.map((message, index) => (
            <MessagePreviewCard key={message.scenario} message={message} index={index} />
          ))}
        </div>
